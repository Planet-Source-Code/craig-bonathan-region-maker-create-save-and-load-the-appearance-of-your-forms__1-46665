...
Function SaveRegion(FileName As String, RegionData As RegionData_Type)
    ...
    Open FileName For Binary As #FileNum
        Put #FileNum, 1, RegionData.Width
        Put #FileNum, 5, RegionData.Height
        Put #FileNum, 9, RegionData.Data()
    Close #FileNum
End Function
...
Function LoadRegion(FileName As String) As RegionData_Type
    ...
    FileNum = FreeFile
    Open FileName For Binary As #FileNum
        Get #FileNum, 1, LoadRegion.Width
        Get #FileNum, 5, LoadRegion.Height
        ReDim LoadRegion.Data(LoadRegion.Width * LoadRegion.Height - 1)
        Get #FileNum, 9, LoadRegion.Data()
    Close #FileNum
End Function
